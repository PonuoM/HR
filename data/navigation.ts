...
export const SIDEBAR_NAV_ITEMS: NavItem[] = [
    ...
    { path: '/approval/history', icon: 'history', label: 'ประวัติขออนุมัติ' },
...
export const SIDEBAR_ADMIN_ITEMS: NavItem[] = [
    ...
    { path: '/admin/quota-overview', icon: 'beach_access', label: 'ภาพรวมโควต้า' },
    ...
    // วันทำงานพิเศษ — optional/advanced; hidden from the menu to keep HR's view simple.
    // Route still works at /admin/work-days if needed.
    // { path: '/admin/work-days', icon: 'event_available', label: 'วันทำงานพิเศษ' },
...
export const PROFILE_ADMIN_ITEMS: ProfileMenuItem[] = [
    ...
    { icon: 'beach_access', label: 'ภาพรวมโควต้าทุกคน', path: '/admin/quota-overview', color: 'bg-cyan-100 text-cyan-600' },
    ...
    // วันทำงานพิเศษ — hidden from menu (optional/advanced); route /admin/work-days still works.
    // { icon: 'event_available', label: 'วันทำงานพิเศษ', path: '/admin/work-days', color: 'bg-lime-100 text-lime-600' },
