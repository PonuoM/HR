...
export const DEFAULT_LEAVE_TYPES: AdminLeaveType[] = [
    { id: 1, name: 'ลาพักร้อน (Vacation)', defaultQuota: 6, unit: 'days', type: 'seniority', resetCycle: 'year', color: 'orange', icon: 'beach_access', iconUrl: null, isActive: true, requiresDoc: false, probationMonths: 6, grantTiming: 'immediate', prorateFirstYear: true, advanceNoticeDays: 3, autoApprove: false, seniorityTiers: [{ minYears: 1, days: 6 }, { minYears: 3, days: 8 }, { minYears: 5, days: 10 }, { minYears: 10, days: 15 }] },
    { id: 2, name: 'ลาป่วย (Sick Leave)', defaultQuota: 30, unit: 'days', type: 'annual', resetCycle: 'year', color: 'green', icon: 'local_hospital', iconUrl: null, isActive: true, requiresDoc: true, probationMonths: 0, grantTiming: 'next_year', prorateFirstYear: false, advanceNoticeDays: 0, autoApprove: false, seniorityTiers: [] },
    { id: 3, name: 'ลากิจ (Business)', defaultQuota: 3, unit: 'days', type: 'annual', resetCycle: 'year', color: 'blue', icon: 'business_center', iconUrl: null, isActive: true, requiresDoc: false, probationMonths: 0, grantTiming: 'next_year', prorateFirstYear: false, advanceNoticeDays: 0, autoApprove: false, seniorityTiers: [] },
    { id: 4, name: 'ลาทำหมัน (Sterilization)', defaultQuota: 1, unit: 'days', type: 'lifetime', resetCycle: 'never', color: 'pink', icon: 'pregnant_woman', iconUrl: null, isActive: true, requiresDoc: true, probationMonths: 0, grantTiming: 'next_year', prorateFirstYear: false, advanceNoticeDays: 0, autoApprove: false, seniorityTiers: [] },
    { id: 5, name: 'ลาไม่รับค่าจ้าง (No Pay)', defaultQuota: 0, unit: 'days', type: 'unpaid', resetCycle: 'year', color: 'gray', icon: 'money_off', iconUrl: null, isActive: true, requiresDoc: false, probationMonths: 0, grantTiming: 'next_year', prorateFirstYear: false, advanceNoticeDays: 0, autoApprove: false, seniorityTiers: [] },
];
