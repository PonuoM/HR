                                        ...
                                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-3 space-y-2.5 bg-gray-50/50 dark:bg-gray-900/30 rounded-b-xl">
                                            <div>
                                                ...
                                                <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1 leading-snug">
                                                    ใส่ตัวแปรได้: <code className="text-cyan-600 dark:text-cyan-400">{'{user_name}'}</code>, <code className="text-cyan-600 dark:text-cyan-400">{'{employee_id}'}</code>, <code className="text-cyan-600 dark:text-cyan-400">{'{nickname}'}</code>, <code className="text-cyan-600 dark:text-cyan-400">{'{company_id}'}</code> — จะถูกแทนด้วยข้อมูลพนักงานตอนคลิก
                                                </p>
                                            </div>
